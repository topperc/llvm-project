...
; RV64-1024-NEXT:    vsetvli zero, a1, e16, m4, tu, mu
; RV64-1024-NEXT:    vslideup.vx v28, v8, a3
...
; RV64-1024-NEXT:    vmv.s.x v12, a2
; RV64-1024-NEXT:    vsetvli zero, a1, e16, m4, ta, mu
; RV64-1024-NEXT:    vrgather.vv v16, v24, v8
; RV64-1024-NEXT:    vmv1r.v v0, v12
; RV64-1024-NEXT:    lui a2, %hi(.LCPI0_2)
; RV64-1024-NEXT:    addi a2, a2, %lo(.LCPI0_2)
; RV64-1024-NEXT:    vle16.v v8, (a2)
; RV64-1024-NEXT:    vsetivli zero, 2, e64, m1, tu, mu
; RV64-1024-NEXT:    vslideup.vi v0, v12, 1
; RV64-1024-NEXT:    vsetivli zero, 3, e64, m1, tu, mu
; RV64-1024-NEXT:    vslideup.vi v0, v12, 2
; RV64-1024-NEXT:    vsetivli zero, 4, e64, m1, tu, mu
; RV64-1024-NEXT:    vslideup.vi v0, v12, 3
; RV64-1024-NEXT:    vsetvli zero, a1, e16, m4, tu, mu
; RV64-1024-NEXT:    vrgather.vv v16, v28, v8, v0.t
; RV64-1024-NEXT:    vsetvli zero, zero, e16, m4, ta, mu
...
; RV64-1024-NEXT:    csrr a4, vlenb
; RV64-1024-NEXT:    addi a5, zero, 24
; RV64-1024-NEXT:    mul a4, a4, a5
; RV64-1024-NEXT:    add a4, sp, a4
; RV64-1024-NEXT:    addi a4, a4, 16
; RV64-1024-NEXT:    vs8r.v v24, (a4) # Unknown-size Folded Spill
; RV64-1024-NEXT:    lui a4, %hi(.LCPI1_0)
; RV64-1024-NEXT:    addi a4, a4, %lo(.LCPI1_0)
; RV64-1024-NEXT:    vle16.v v8, (a4)
; RV64-1024-NEXT:    addi a4, sp, 16
; RV64-1024-NEXT:    vs8r.v v8, (a4) # Unknown-size Folded Spill
; RV64-1024-NEXT:    vmv8r.v v8, v24
...
; RV64-1024-NEXT:    vrgather.vv v0, v8, v24
; RV64-1024-NEXT:    csrr a2, vlenb
...
; RV64-1024-NEXT:    vsetvli zero, a1, e16, m8, tu, mu
; RV64-1024-NEXT:    vslideup.vx v24, v16, a3
; RV64-1024-NEXT:    csrr a2, vlenb
; RV64-1024-NEXT:    addi a3, zero, 24
...
; RV64-1024-NEXT:    addi a2, a2, 16
; RV64-1024-NEXT:    vl8re8.v v8, (a2) # Unknown-size Folded Reload
; RV64-1024-NEXT:    vrgather.vv v24, v0, v8
; RV64-1024-NEXT:    addi a2, sp, 16
; RV64-1024-NEXT:    vs8r.v v24, (a2) # Unknown-size Folded Spill
...
; RV64-2048-NEXT:    vmv.s.x v16, a2
; RV64-2048-NEXT:    vsetvli zero, a1, e16, m4, ta, mu
; RV64-2048-NEXT:    vrgather.vv v8, v24, v12
; RV64-2048-NEXT:    vmv1r.v v0, v16
; RV64-2048-NEXT:    vsetivli zero, 2, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 1
; RV64-2048-NEXT:    vsetivli zero, 3, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 2
; RV64-2048-NEXT:    vsetivli zero, 4, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 3
; RV64-2048-NEXT:    vsetivli zero, 5, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 4
; RV64-2048-NEXT:    lui a2, %hi(.LCPI1_2)
; RV64-2048-NEXT:    addi a2, a2, %lo(.LCPI1_2)
; RV64-2048-NEXT:    vsetvli zero, a1, e16, m4, ta, mu
; RV64-2048-NEXT:    vle16.v v12, (a2)
; RV64-2048-NEXT:    vsetivli zero, 6, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 5
; RV64-2048-NEXT:    vsetivli zero, 7, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 6
; RV64-2048-NEXT:    vsetivli zero, 8, e64, m1, tu, mu
; RV64-2048-NEXT:    vslideup.vi v0, v16, 7
; RV64-2048-NEXT:    vsetvli zero, a1, e16, m4, tu, mu
