...
; RV32-LABEL: vrgather_shuffle_vv_v4i16:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vslideup.vi v27, v25, 3
...
; RV32-NEXT:    vrgather.vv v25, v9, v27, v0.t
; RV32-NEXT:    vmv1r.v v8, v25
; RV32-NEXT:    ret
;
; RV64-LABEL: vrgather_shuffle_vv_v4i16:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vslideup.vi v27, v25, 3
...
; RV64-NEXT:    vrgather.vv v25, v9, v27, v0.t
...
; RV32-NEXT:    vmv.s.x v27, a0
; RV32-NEXT:    vsetvli zero, zero, e16, m1, tu, mu
; RV32-NEXT:    vslideup.vi v26, v27, 7
; RV32-NEXT:    vsetvli zero, zero, e64, m4, ta, mu
; RV32-NEXT:    vrgatherei16.vv v28, v8, v25
