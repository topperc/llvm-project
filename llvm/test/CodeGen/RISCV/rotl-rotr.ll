...
; RV32XTHEADBB-NEXT:    sll a3, a1, a2
; RV32XTHEADBB-NEXT:    not a5, a2
; RV32XTHEADBB-NEXT:    srli a6, a0, 1
; RV32XTHEADBB-NEXT:    srl a5, a6, a5
...
; RV32XTHEADBB-NEXT:    andi a7, a5, 63
; RV32XTHEADBB-NEXT:    addi a6, a7, -32
; RV32XTHEADBB-NEXT:    and a4, a4, t0
; RV32XTHEADBB-NEXT:    bltz a6, .LBB11_5
; RV32XTHEADBB-NEXT:  # %bb.4:
; RV32XTHEADBB-NEXT:    srl a0, a1, a7
...
; RV32I-NEXT:    or a3, a3, a5
; RV32I-NEXT:  .LBB14_3:
; RV32I-NEXT:    srl t0, a1, a2
; RV32I-NEXT:    srai a4, a4, 31
; RV32I-NEXT:    neg a5, a2
; RV32I-NEXT:    andi a7, a5, 63
; RV32I-NEXT:    addi a6, a7, -32
; RV32I-NEXT:    and a4, a4, t0
; RV32I-NEXT:    bltz a6, .LBB14_5
; RV32I-NEXT:  # %bb.4:
; RV32I-NEXT:    sll a1, a0, a7
...
; RV32ZBB-NEXT:    sll a5, a6, a5
; RV32ZBB-NEXT:    or a3, a3, a5
; RV32ZBB-NEXT:  .LBB14_3:
; RV32ZBB-NEXT:    srl t0, a1, a2
; RV32ZBB-NEXT:    srai a4, a4, 31
; RV32ZBB-NEXT:    neg a5, a2
; RV32ZBB-NEXT:    andi a7, a5, 63
; RV32ZBB-NEXT:    addi a6, a7, -32
; RV32ZBB-NEXT:    and a4, a4, t0
; RV32ZBB-NEXT:    bltz a6, .LBB14_5
; RV32ZBB-NEXT:  # %bb.4:
; RV32ZBB-NEXT:    sll a1, a0, a7
...
; RV32XTHEADBB-NEXT:    sll a5, a6, a5
; RV32XTHEADBB-NEXT:    or a3, a3, a5
; RV32XTHEADBB-NEXT:  .LBB14_3:
; RV32XTHEADBB-NEXT:    srl t0, a1, a2
; RV32XTHEADBB-NEXT:    srai a4, a4, 31
; RV32XTHEADBB-NEXT:    neg a5, a2
; RV32XTHEADBB-NEXT:    andi a7, a5, 63
; RV32XTHEADBB-NEXT:    addi a6, a7, -32
; RV32XTHEADBB-NEXT:    and a4, a4, t0
; RV32XTHEADBB-NEXT:    bltz a6, .LBB14_5
; RV32XTHEADBB-NEXT:  # %bb.4:
; RV32XTHEADBB-NEXT:    sll a1, a0, a7
...
; RV32I-NEXT:    srli a7, a5, 31
; RV32I-NEXT:    mv a6, a0
; RV32I-NEXT:    bnez a7, .LBB17_2
; RV32I-NEXT:  # %bb.1:
; RV32I-NEXT:    mv a6, a1
; RV32I-NEXT:  .LBB17_2:
; RV32I-NEXT:    andi a5, a4, 63
; RV32I-NEXT:    sll t0, a6, a4
; RV32I-NEXT:    bnez a7, .LBB17_4
; RV32I-NEXT:  # %bb.3:
; RV32I-NEXT:    mv a1, a0
; RV32I-NEXT:  .LBB17_4:
...
; RV32ZBB-NEXT:    srli a7, a5, 31
; RV32ZBB-NEXT:    mv a6, a0
; RV32ZBB-NEXT:    bnez a7, .LBB17_2
; RV32ZBB-NEXT:  # %bb.1:
; RV32ZBB-NEXT:    mv a6, a1
; RV32ZBB-NEXT:  .LBB17_2:
; RV32ZBB-NEXT:    andi a5, a4, 63
; RV32ZBB-NEXT:    sll t0, a6, a4
; RV32ZBB-NEXT:    bnez a7, .LBB17_4
; RV32ZBB-NEXT:  # %bb.3:
...
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    th.extu a7, a4, 5, 5
; RV32XTHEADBB-NEXT:    mv a6, a0
; RV32XTHEADBB-NEXT:    bnez a7, .LBB17_2
; RV32XTHEADBB-NEXT:  # %bb.1:
; RV32XTHEADBB-NEXT:    mv a6, a1
; RV32XTHEADBB-NEXT:  .LBB17_2:
; RV32XTHEADBB-NEXT:    andi a5, a4, 63
; RV32XTHEADBB-NEXT:    sll t0, a6, a4
; RV32XTHEADBB-NEXT:    bnez a7, .LBB17_4
...
; RV32XTHEADBB-NEXT:    srl a0, a0, a7
; RV32XTHEADBB-NEXT:    or a1, t0, a0
; RV32XTHEADBB-NEXT:    addi a0, a5, -32
; RV32XTHEADBB-NEXT:    srl a6, a6, a7
...
; RV32XTHEADBB-NEXT:    srli a5, a2, 1
; RV32XTHEADBB-NEXT:    srl a5, a5, a7
; RV32XTHEADBB-NEXT:    or a3, a3, a5
...
; RV32ZBB-NEXT:    sll a0, a1, a7
; RV32ZBB-NEXT:    or a1, a0, t0
; RV32ZBB-NEXT:    addi a0, a5, -32
...
; RV32XTHEADBB-NEXT:    sll a0, a1, a7
; RV32XTHEADBB-NEXT:    or a1, a0, t0
; RV32XTHEADBB-NEXT:    addi a0, a5, -32
